...
function(uammd_setup_target target_name)
  ...
  target_link_libraries(${target_name} PUBLIC BLAS::BLAS LAPACK::LAPACK)
  set(BLAS_PREV "")
  ...
  if(DEFINED MKL_INCLUDE_DIR)
    ...
    target_include_directories(${target_name} PUBLIC ${MKL_INCLUDE_DIR})
  else()
    # Not MKL mode
    target_link_libraries(${target_name} PUBLIC lapacke)
    ...
    target_include_directories(${target_name} PUBLIC ${BLAS_INCLUDE_DIR} ${LAPACKE_INCLUDE_DIR})
  endif()
