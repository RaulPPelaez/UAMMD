...
function(uammd_setup_target target_name)
  ...
  if(USE_OPENMP)
    ...
    if(OPENMP_CXX_FOUND AND OPENMP_CUDA_FOUND)
    target_link_libraries(${target_name} PRIVATE OpenMP::OpenMP_CUDA OpenMP::OpenMP_CXX)
    endif()
  endif()
  if(USE_EIGEN)
    find_package(Eigen3 3 REQUIRED)
    target_compile_definitions(${target_name} PRIVATE USE_EIGEN EIGEN_NO_CUDA)
