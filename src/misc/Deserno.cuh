...
This file contains an Interactor that given files with bonds describing Deserno lipids can compute the forces and energies given by the Deserno potential[1].
...
[1] Tunable generic model for fluid bilayer membranes. Ira R. Cooke, Kurt Kremer, and Markus Deserno DOI: 10.1103/PhysRevE.72.011506
 */
#ifndef DESERNO_CUH
#define DESERNO_CUH
