...
public:
  ...
  HOSTDEVICE inline T& operator [](int i){
  ...
  inline operator T*(){ return this->gpu.data();} /*This is just ugly, but for backwards compatibility...*/
...
public:
  ...
  HOSTDEVICE inline  iterator begin(){ return this->d_m;}
  HOSTDEVICE inline iterator end(){ return this->d_m+n;}
  HOSTDEVICE inline int size(){return this->n;}
  ...
  __device__ inline T& operator[](int i){ return d_m[i];}
...
public:
  ...
  inline T& operator [](int i){ return h_m[i];}
