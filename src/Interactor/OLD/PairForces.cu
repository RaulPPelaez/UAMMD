...
void PairForces::init(){
  ...
  case LJ:
    ...
    pot = Potential(Potential::forceLJ, Potential::energyLJ, 4096*params.rcut/real(2.5), params.rcut, ntypes);
    break;
  case CUSTOM:
    ...
    break;
  case NONE:
    pot = Potential(Potential::nullForce, Potential::nullForce, 2, params.rcut, ntypes);
    break;
  default:
