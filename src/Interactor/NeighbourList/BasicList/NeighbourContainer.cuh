...
namespace uammd{
  ...
  namespace BasicNeighbourList_ns{
	...
	return other.particleIndex == particleIndex and other.currentNeighbourCounter==currentNeighbourCounter;
      }

      __device__ NeighbourIterator(int i, BasicNeighbourListBase::BasicNeighbourListData nl, bool begin):
	particleIndex(i),
	currentNeighbourCounter(-1),
    ...
    struct NeighbourContainer{
      int my_i = -1;
      BasicNeighbourListBase::BasicNeighbourListData nl;
      NeighbourContainer(BasicNeighbourListBase::BasicNeighbourListData nl): nl(nl){}
