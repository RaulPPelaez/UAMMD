/*Raul P. Pelaez 2020. Chebyshev Boundary conditions for the  Doubly Periodic
Poisson solver. Slab geometry. In this case they are just trivial and equal to 1
all the time. Maybe this class could be ommited.
*/
