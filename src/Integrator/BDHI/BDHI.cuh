...
namespace uammd{
  namespace BDHI{
	...
	return c12*(M0*invrh);
      ...
      //Taken from "Rotne–Prager–Yamakawa approximation for different-sized particles in application to macromolecular bead models", P.J. Zik et.al. 2014
      inline __host__  __device__  real2  RPY_differentSizes(real r, real ai, real aj) const{
	...
	return c12;
      ...
      //Computes f(r) and g(r)/r^2 given the distance r and the particle radius of both particles
      inline __host__  __device__  real2  operator()(real r, real a_i, real a_j) const{
	if(a_i==a_j)
