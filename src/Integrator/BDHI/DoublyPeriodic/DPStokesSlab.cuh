...
public:
  ...
  // Computes the linear and angular hydrodynamic displacements (velocities)
  // coming from
  //  the forces and torques acting on a group of positions
  // If the torques pointer is null, the function will only compute and return
  ...
  // compute average velocity in the x (0, default) or y (1) directions as a
  // function of z
  template <class PosIterator, class ForceIterator>
  std::vector<double>
