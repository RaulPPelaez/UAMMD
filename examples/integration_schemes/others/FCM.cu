/*Raul P. Pelaez 2018. FCM/PSE example
  Non interacting particles inside a box starting in an FCC lattice fluctuate
via the periodic FCM/RPY hydrodynamic kernel with the Force coupling method.
